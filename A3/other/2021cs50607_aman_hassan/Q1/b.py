...
if __name__ == '__main__':
    ...
    plot_graphs(X_train,y_train,X_test,y_test,types,[15,25,35,45])
...
Output:
Only Win:
    Accuracy for in prediction type of only win on training set is 50.3386
    Accuracy for in prediction type of only win on test set is 49.6381
Only Loss:
...
DT with varying depths on training set:
    Accuracy for depth 15 on training set is 70.6018
    Accuracy for depth 25 on training set is 84.9112
    Accuracy for depth 35 on training set is 92.5514
    Accuracy for depth 45 on training set is 99.1057
DT with varying depths on test set:
    Accuracy for depth 15 on test set is 55.9462
    Accuracy for depth 25 on test set is 61.7373
    Accuracy for depth 35 on test set is 61.5305
    Accuracy for depth 45 on test set is 61.5305
'''
